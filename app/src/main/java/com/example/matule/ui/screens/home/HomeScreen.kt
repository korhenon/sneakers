...
import com.example.matule.ui.theme.poppins
import com.example.matule.ui.theme.raleway
import com.example.matule.ui.widget.BottomNavigation
import com.example.matule.ui.widget.CategoryItem
import com.example.matule.ui.widget.ProductGrid
    ...
    Scaffold(bottomBar = {
        ...
        Column(
            ...
            Row(
                ...
                CategoryItem(text = "Все", onClick = {})
                Spacer(Modifier.width(16.dp))
                for (category in viewModel.productsByCategory.keys) {
            ...
            Column(
                ...
                ProductGrid(viewModel.popular.take(2)) { id, event ->
                    println("$id $event")
                }
                Spacer(Modifier.height(30.dp))
                Row(
